  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <p>Review and edit the extracted events before adding to your calendar</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          For best results, ensure your image is clear and well-lit. Text should be easily readable.
        </AlertDescription>
      </Alert>
